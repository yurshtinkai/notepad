...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Check if offline
    if (!isOnline) {
      setError('You are currently offline. Login requires an internet connection.');
      return;
    }
            ...
            <form className="auth-form" onSubmit={handleSubmit} noValidate>
              ...
              <button 
                ...
                style={{
                  ...
                  fontSize: '15px',
                  fontWeight: 600,
                  cursor: isGoogleLoading || !isOnline ? 'not-allowed' : 'pointer',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: '10px',
                  transition: 'all 0.2s',
                  opacity: isGoogleLoading || !isOnline ? 0.6 : 1,
                }}
                onMouseEnter={(e) => {
                  if (!isGoogleLoading && isOnline) {
